...
class FolderTest extends TestCase {
	...
	public function testInPath(): void {
		$this->skipIf(true, 'Something seems wrong here');

		$basePath = '/tests/test_app/';
	 ...
	 * @return array
	 */
	public static function inPathInvalidPathArgumentDataProvider(): array {
		return [
			[''],
			['relative/path/'],
	...
	public function testIsRegisteredStreamWrapper(): void {
		...
		stream_wrapper_register($wrapper, static::class);
		$this->assertTrue(Folder::isRegisteredStreamWrapper($wrapper . '://path/to/file'));
