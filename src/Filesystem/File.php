 ...
 *
 * @deprecated 4.0.0 Only used for tests.
 */
class File {
	 ...
	 *
	 * @param int|bool|false $offset The $offset in bytes to seek. If set to false then the current offset is returned.
